...
public interface LocationsApi {
    ...
    @ApiOperation(value = "", nickname = "locationsPost", notes = "returns TOs based on the search conditions", response = MaasLocation.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A new booking was succesfully created, status pending", response = MaasLocation.class, responseContainer = "List"),
    ...
    ResponseEntity<List<MaasLocation>> locationsPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody SearchCondition body
