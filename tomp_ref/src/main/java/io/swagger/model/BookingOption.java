...
public class BookingOption   {
  ...
  /**
   * unique ID (TO's perspective) for identifying this specific available leg
   * @return id
  **/
  @ApiModelProperty(required = true, value = "unique ID (TO's perspective) for identifying this specific available leg")
      @NotNull
