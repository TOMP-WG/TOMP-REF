...
,@ApiParam(value = "Leg identifier",required=true) @PathVariable("id") String id
    ...
    @ApiOperation(value = "", nickname = "legsIdAvailableAssetsGet", notes = "Returns a list of available assets for the given booking. These assets can be used to POST to /legs/{id}/asset if no specific asset is assigned by the TO. If picking an asset is not allowed for this booking, or one already has been, 403 should be returned. If the booking is unknown, 404 should be returned. See (4.7) in the process flow. - trip execution", response = Asset.class, responseContainer = "List", authorizations = {
        @Authorization(value = "ApiKeyAuth"),
@Authorization(value = "BasicAuth"),
@Authorization(value = "BearerAuth"),
@Authorization(value = "OAuth", scopes = { 
...
@Authorization(value = "OpenId")    }, tags={ "trip execution","TO", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Available assets for the booking. If no suitable assets are found an empty array is to be returned.", response = Asset.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Authorization error (invalid API key) or insufficient access rights given current authorization.", response = Error.class),
    ...
    @RequestMapping(value = "/legs/{id}/available-assets",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Asset>> legsIdAvailableAssetsGet(@ApiParam(value = "ISO 639-1 two letter language code" ,required=true) @RequestHeader(value="Accept-Language", required=true) String acceptLanguage
,@ApiParam(value = "API description, can be TOMP or maybe other (specific/derived) API definitions" ,required=true) @RequestHeader(value="Api", required=true) String api
,@ApiParam(value = "Version of the API." ,required=true) @RequestHeader(value="Api-Version", required=true) String apiVersion
