...
public class JSON {
	...
	public static GsonBuilder createGson() {
		GsonFireBuilder fireBuilder = new GsonFireBuilder()
				.registerTypeSelector(BookingRequest.class, new TypeSelector<BookingRequest>() {
				...
				}).registerTypeSelector(PlanningRequest.class, new TypeSelector<PlanningRequest>() {
					@Override
					public Class<? extends PlanningRequest> getClassForElement(JsonElement readElement) {
						Map<String, Class<? extends PlanningRequest>> classByDiscriminatorValue = new HashMap<>();
						classByDiscriminatorValue.put("bookingRequest".toUpperCase(), BookingRequest.class);
						classByDiscriminatorValue.put("planning".toUpperCase(), Planning.class);
						classByDiscriminatorValue.put("PlanningRequest".toUpperCase(), PlanningRequest.class);
						return getClassByDiscriminator(classByDiscriminatorValue,
								getDiscriminatorValue(readElement, ""));
					}
				}).registerPostProcessor(PlanningRequest.class, new PostProcessor<PlanningRequest>() {
					@Override
					public void postDeserialize(PlanningRequest result, JsonElement src, Gson gson) {

					}

					@Override
					public void postSerialize(JsonElement result, PlanningRequest src, Gson gson) {
						Map<Class<? extends PlanningRequest>, String> discriminatorValueByClass = new HashMap<>();
						discriminatorValueByClass.put(BookingRequest.class, "bookingRequest");
						discriminatorValueByClass.put(Planning.class, "planning");
						discriminatorValueByClass.put(PlanningRequest.class, "PlanningRequest");
						if (result instanceof JsonObject) {
							if (!((JsonObject) result).has("")) {
								((JsonObject) result).addProperty("", discriminatorValueByClass.get(src.getClass()));
							}
					...
					public Class<? extends Condition> getClassForElement(JsonElement readElement) {
						...
						classByDiscriminatorValue.put("conditionPayWhenFinished".toUpperCase(),
								ConditionPayWhenFinished.class);
						classByDiscriminatorValue.put("conditionPostponedCommit".toUpperCase(),
								ConditionPostponedCommit.class);
						classByDiscriminatorValue.put("conditionRequireBookingData".toUpperCase(),
								ConditionRequireBookingData.class);
						classByDiscriminatorValue.put("conditionReturnArea".toUpperCase(), ConditionReturnArea.class);
						classByDiscriminatorValue.put("conditionUpfrontPayment".toUpperCase(),
								ConditionUpfrontPayment.class);
