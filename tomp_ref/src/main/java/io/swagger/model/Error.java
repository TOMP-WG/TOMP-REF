 ...
 */
@ApiModel(description = "An error that the service may send, e.g. in case of invalid input, missing authorization or internal service error. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code.")
@Validated
...
public class Error   {
   ...
   * @return errorcode
  **/
  @ApiModelProperty(value = "The TOMP specific error code. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for more details of this error.")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The category of this type of error.")
