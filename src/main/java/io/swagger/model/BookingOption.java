...
/**
 * A new booking, created by MaaS POST request in &#x27;PENDING&#x27; state. The ID is generated by the TO in the &#x27;availability-check&#x27;. The from-address, to-address and the personal data should only be provided if there is an actual request for it (see conditions)
 */
@ApiModel(description = "A new booking, created by MaaS POST request in 'PENDING' state. The ID is generated by the TO in the 'availability-check'. The from-address, to-address and the personal data should only be provided if there is an actual request for it (see conditions)")
@Validated
