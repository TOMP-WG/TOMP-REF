...
class Place(Model):
    ...
    def __init__(self, name: str=None, stop_reference: List[StopReference]=None, station_id: str=None, coordinates: Coordinates=None, physical_address: Address=None, extra_info: Dict=None):  # noqa: E501
        ...
        :type name: str
        :param stop_reference: The stop_reference of this Place.  # noqa: E501
        :type stop_reference: List[StopReference]
        :param station_id: The station_id of this Place.  # noqa: E501
        :type station_id: str
        :param coordinates: The coordinates of this Place.  # noqa: E501
        :type coordinates: Coordinates
        :param physical_address: The physical_address of this Place.  # noqa: E501
        :type physical_address: Address
        :param extra_info: The extra_info of this Place.  # noqa: E501
    ...
    def stop_reference(self) -> List[StopReference]:
        """Gets the stop_reference of this Place.


        :return: The stop_reference of this Place.
    ...
    def stop_reference(self, stop_reference: List[StopReference]):
        """Sets the stop_reference of this Place.


        :param stop_reference: The stop_reference of this Place.
        :type stop_reference: List[StopReference]
        """
    ...
    def station_id(self) -> str:
        """Gets the station_id of this Place.

        reference to /operator/stations  # noqa: E501

        :return: The station_id of this Place.
        :rtype: str
        """
    ...
    def station_id(self, station_id: str):
        """Sets the station_id of this Place.

        reference to /operator/stations  # noqa: E501

        :param station_id: The station_id of this Place.
        :type station_id: str
        """
    ...
    def physical_address(self) -> Address:
        """Gets the physical_address of this Place.


        :return: The physical_address of this Place.
        :rtype: Address
        """
    ...
    def physical_address(self, physical_address: Address):
        """Sets the physical_address of this Place.


        :param physical_address: The physical_address of this Place.
        :type physical_address: Address
        """
    ...
    def extra_info(self) -> Dict:
        """Gets the extra_info of this Place.


        :return: The extra_info of this Place.
        :rtype: Dict
        """
    ...
    def extra_info(self, extra_info: Dict):
        """Sets the extra_info of this Place.


        :param extra_info: The extra_info of this Place.
        :type extra_info: Dict
        """
