...
@SecurityRequirement(name = "OpenId")    }, tags={ "booking [optional]", "TO" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The bookings matching the query", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Booking.class)))),
...
@SecurityRequirement(name = "OpenId")    }, tags={ "booking", "MP", "TO" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The modified booking", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))),
...
@SecurityRequirement(name = "OpenId")    }, tags={ "booking", "TO" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The booking was found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))),
...
@SecurityRequirement(name = "OpenId")    }, tags={ "general", "TO" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The bookings matching the query", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Notification.class)))),
...
@SecurityRequirement(name = "OpenId")    }, tags={ "booking [optional]", "TO" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "The booking was modified", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))),
...
@SecurityRequirement(name = "OpenId")    }, tags={ "booking", "TO", "MP" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "A new booking was succesfully created, status pending", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))),
